...
class AwsServices:
    ...
    def publish_elb_ip_count_metric(self, ip_dict):
        """
        Add IPCount to CloudWatch metric for tracking CLB node count
        :param ip_dict: IP meta data dict e.g.
        {
            'LoadBalancerName': 'internal-CLB1-78665219.us-east-1.elb.amazonaws.com',
